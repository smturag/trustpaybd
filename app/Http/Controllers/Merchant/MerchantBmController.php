...
class MerchantBmController extends Controller
{
    ...
    $qrdata->whereBetween('created_at', [$start_date, $end_date]);
        ...
        if ($request->ajax()) {
            return view('merchant.bm.balance-manager-content', compact('data'));
        }

        return view('merchant.bm.balance-manager', compact('data', 'sim'));
    }
       ...
       public function approved_balance_manager(Request $request, $id)
    {
        ...
        return view('merchant.bm.balance-manager-approved', compact('request_data'));
    }
        ...
        public function view_balance_manager($id)
    {
        ...
        return view('merchant.bm.balance-manager-view', compact('userdata', 'request_data'));
    }
}