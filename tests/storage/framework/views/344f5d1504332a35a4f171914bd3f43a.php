                            ...
                            <div class="card-body">
                                ...
                                <div class="p-4">
                                    ...
                                    <div class="form-body">
                                        ...
                                        <form action="<?php echo e(route('merchantloginAction')); ?>" method="POST"
                                            class="row g-3">
                                            ...
                                            <div class="col-12">
                                                <div class="text-center ">
                                                    <p class="mb-0"> <a
                                                            href="<?php echo e(route('merchant.forget_pass_page')); ?>">Forget
                                                            Password</a></p>
                                                </div>
                                            </div>
...
<?php echo $__env->make('welcome', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Rahim Vai\Gateway\payment-gateway\resources\views/merchant/merchant_login.blade.php ENDPATH**/ ?>