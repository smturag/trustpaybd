<?php $__env->startSection('title', 'Modem'); ?>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="table-responsive" id="tableContentWrap">
                                <?php echo $__env->make('member.member_modem.modem_table_content', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                            </div>
        ...
        function delete_record(id, title) {
            ...
            swal({
                ...
                .then((isConfirm) => {
                    if (isConfirm) {
                        $.ajax({
                            url: "<?php echo e(url('member_modem_delete/')); ?>/" + id,
...
<?php echo $__env->make('member.layout.member_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Rahim Vai\Gateway\payment-gateway\resources\views/member/member_modem/modem_list.blade.php ENDPATH**/ ?>