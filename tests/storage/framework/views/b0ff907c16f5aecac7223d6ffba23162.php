<?php $__env->startSection('title', 'Merchant Payment'); ?>
...
<?php $__env->startSection('content'); ?>
    ...
    <div class="row">
        <div class="col-xl-12 mx-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="#" data-route="<?php echo e(route('admin.merchant.payment-request')); ?>"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control select2" name="merchant_id" id="merchant_id">
                                        ...
                                        <?php $__currentLoopData = $merchants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $merchant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                            <option value="<?php echo e($merchant->id); ?>"><?php echo e($merchant->fullname); ?></option>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="table-responsive" id="tableContentWrap">
                        <?php echo $__env->make('admin.merchant.payment-request.data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
...
<?php $__env->startPush('js'); ?>
    <script type="text/javascript">
        ...
        const rejectBtn = document.querySelectorAll('.rejectPaymentBtn');
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            form.addEventListener("submit", function(event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('reject-payment-request')); ?>", // Comma was missing here
                    dataType: 'json',
        ...
        $(document).ready(function() {
            ...
            $('#completePaymentBtn').click(function(e) {
                e.preventDefault();
                ...
                if (confirmed) {
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo e(route('approve-payment-request', ['id' => ':id'])); ?>".replace(
                            ':id', paymentId),
                        dataType: 'json',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        const approveBtn = document.querySelectorAll('.completePaymentBtn');
...
<?php echo $__env->make('admin.layouts.admin_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Rahim Vai\Gateway\payment-gateway\resources\views/admin/merchant/payment-request/request-list.blade.php ENDPATH**/ ?>