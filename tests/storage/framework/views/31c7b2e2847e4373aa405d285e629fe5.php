    ...
    <div class="row">
        <div class="col-xl-12 mx-auto">
            <div class="header d-flex align-items-center mb-3">
                <h6 class="mb-0 text-uppercase ps-3">Partner List</h6>
                <a class="ms-auto btn btn-sm btn-primary" href="<?php echo e(route('userAdd')); ?>">
                    <i class="bx bx-plus mr-1"></i> New Partner
                </a>
            </div>
            <hr />
                ...
                <div class="card-body">
                    <form action="#" class="mb-5 justify-content-center" role="form" method="post" id="search-form"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="mtype"><?php echo e(translate('type')); ?></label>
                    ...
                    <div class="table-responsive" id="tableContentWrap">
                        <?php echo $__env->make('admin.users.user_data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
                ...
                <form method="post" action="" class="row g-3">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Agent ID'); ?> </label>
...
<?php echo $__env->make('admin.layouts.admin_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Rahim Vai\Gateway\payment-gateway\resources\views/admin/users/user_list.blade.php ENDPATH**/ ?>