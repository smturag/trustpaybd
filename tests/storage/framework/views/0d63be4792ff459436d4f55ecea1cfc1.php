<?php $__env->startSection('member_content'); ?>
    ...
    <div class="row">
        <div class="col-xl-12 mx-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="#" method="GET" data-route="<?php echo e(route('user.payment-request')); ?>"
                    ...
                    <div class="table-responsive" id="tableContentWrap">
                        <?php echo $__env->make('member.payment_request.data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.openPopup', function(e) {
                e.preventDefault();
                var id = $(this).attr('id');
                var dataURL = "<?php echo e(url('/admin/merchant/payment-request/approved-payment-request')); ?>/" + id;
            ...
            $(document).on('click', '.rejectBalance', function(event) {
                ...
                if (confirm('Are you sure to reject this request?')) {
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo e(url('/admin/merchant/payment-request/reject-payment-request')); ?>/" +
                            id,
                        data: {
                            _token: _token
                        },
        ...
        CompleteButtons.forEach(button => {
            button.addEventListener('click', function() {
                ...
                if (confirmed) {
                    $.ajax({
                        type: 'POST',
                        url: "<?php echo e(route('agent.approve-payment-request', ['id' => ':id'])); ?>"
        ...
        document.addEventListener("DOMContentLoaded", function() {
            ...
            form.addEventListener("submit", function(event) {
                ...
                $.ajax({
                    type: 'POST',
                    url: "<?php echo e(route('agent.reject-payment-request')); ?>", // Comma was missing here
                    dataType: 'json',
...
<?php echo $__env->make('member.layout.member_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Rahim Vai\Gateway\payment-gateway\resources\views/member/payment_request/index.blade.php ENDPATH**/ ?>