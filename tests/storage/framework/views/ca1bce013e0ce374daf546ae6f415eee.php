    ...
    <div class="row">
        <div class="col-xl-12 mx-auto">
            <div class="header d-flex align-items-center mb-3 flex-column flex-sm-row">
                ...
                <a class="ms-sm-auto btn btn-sm btn-primary mt-2 mt-sm-0" href="<?php echo e(route('merchantAdd')); ?>">
                ...
                <div class="card-body">
                    <form action="#" class="mb-5 justify-content-center" role="form" method="post" id="search-form" accept-charset="utf-8">
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    <label for="member_code"><?php echo e(translate('merchant_id')); ?></label>
                    ...
                    <div class="table-responsive" id="tableContentWrap">
                        <?php echo $__env->make('admin.merchant.admin_merchant_data', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                    </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title"> <?php echo app('translator')->get('Add Blance'); ?></h4>
                ...
                <form method="post" action="" class="row g-3">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    <label class="form-label"><?php echo app('translator')->get('Merchant ID'); ?> </label>
        ...
        function delete_record(id, title) {
            ...
            swal({
                ...
                .then((isConfirm) => {
                    if (isConfirm) {
                        $.ajax({
                            url: "<?php echo e(url('admin/merchant_delete/')); ?>/" + id,
...
<?php echo $__env->make('admin.layouts.admin_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Rahim Vai\Gateway\payment-gateway\resources\views/admin/merchant/admin_merchant_list.blade.php ENDPATH**/ ?>