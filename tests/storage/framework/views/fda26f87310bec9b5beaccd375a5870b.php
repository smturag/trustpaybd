        ...
        <div class="alert alert-danger border-0 bg-danger alert-dismissible fade show py-2">
            <div class="d-flex align-items-center">
                ...
                <div class="ms-3">
                    ...
                    <div>
                        <h5><a style="color: yellow;" href="<?php echo e(route('member.profile_view')); ?>">Click Here Go to your
                                profile</a></h5>
                    </div>
                </div>
            </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h4 class="my-1 text-info">৳<?php echo e(money( $userBalance['mainBalance'] )); ?></h4>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h4 class="my-1 text-warning"><?php echo e($total_modem); ?> </h4>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h5 class="my-1">৳<?php echo e(money( $usertype == 'partner'?$userBalance['total_payment_request_today']  : $total_payment_request_today)); ?></h5>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h5 class="my-1">৳<?php echo e(money($usertype == 'partner'?$userBalance['total_payment_request']  : $total_payment_request)); ?></h5>
                            <p class="mb-0 font-12 text-success"><i class='bx bxs-down-arrow align-middle'></i>Only Success
                                + Approved ( <?php echo e($usertype == 'partner'?$userBalance['total_payment_request_transaction']  : $total_payment_request_transection); ?>)</p>
                        </div>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h5 class="my-1">৳<?php echo e(money($userBalance['totalPendingPayment'])); ?></h5>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h5 class="my-1">৳<?php echo e(money($usertype == 'partner'? $userBalance['total_payment_request']  : $today_total_mfs_request)); ?></h5>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h5 class="my-1">৳<?php echo e(money($userBalance['sumOfDebitAmount'])); ?></h5>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h5 class="my-1"> ৳ <?php echo e(money($userBalance['totalPendingMfs'])); ?></h5>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h5 class="my-1">৳ <?php echo e(money($userBalance['adminCreditAmount'])); ?></h5>
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center">
                        <div>
                            ...
                            <h5 class="my-1"> ৳ <?php echo e(money($userBalance['adminDebitAmount'])); ?></h5>
                            <p class="mb-0 font-12 text-primary"><i class='bx bxs-down-arrow align-middle'></i>Only
                                Success
                                + Approved</p>
                        </div>
...
<?php echo $__env->make('member.layout.member_app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH F:\Rahim Vai\Gateway\payment-gateway\resources\views/member/dashboard.blade.php ENDPATH**/ ?>