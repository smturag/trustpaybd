                ...
                <div class="table-responsive">
                    <table id="trade_list" class="table table-striped table-bordered mb-0">
                        ...
                        <tr>
                            ...
                            <th>{{ translate('Deposit Address') }}</th>
                        ...
                        @foreach ($all_request as $drow)
                            ...
                            <tr>
                                ...
                                <td class="text-truncate">{{ $drow->currency_name }}</td>
                                <td class="text-truncate">{{ $drow->network }}</td>
                                <td class="text-truncate">{{ $drow->deposit_address }}</td>
