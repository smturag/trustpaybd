            ...
            <div class="col-md-4">
                <div class="card summary-card payout-card position-relative">
                    <div class="card-body">
                        ...
                        <div class="d-flex justify-content-between mb-1">
                            <span>Pending:</span>
                            <strong class="text-warning">৳ {{ number_format($payoutStats->pending_amount ?? 0, 2) }}</strong>
                        </div>
                        <div class="d-flex justify-content-between mb-1">
                            <span>Approved:</span>
                            <strong class="text-success">৳ {{ number_format($payoutStats->approved_amount ?? 0, 2) }}</strong>
                        </div>
                        <div class="d-flex justify-content-between mb-1">
                            <span>Rejected:</span>
                            <strong class="text-danger">৳ {{ number_format($payoutStats->rejected_amount ?? 0, 2) }}</strong>
                        </div>
                        <hr class="my-2">
                        <div class="d-flex justify-content-between">
                    ...
                    <div class="col-md-8">
                        <table class="table table-borderless">
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <h4 class="mb-0 text-primary">৳ {{ number_format($merchant->available_balance ?? 0, 2) }}</h4>
                                </td>
                            </tr>
                            @php
                        ...
                        <table class="table table-sm">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <span class="badge bg-{{ $currency->status == 0 ? 'warning' : ($currency->status == 4 ? 'success' : 'danger') }}">
                                    ...
                                    <td class="text-end">
                                        ...
                                        <br>
                                        <small class="text-muted">{{ number_format($currency->total_currency, 2) }} {{ strtoupper($currency->merchant_currency) }}</small>
                                    </td>
                                </tr>
                                @empty
                                <tr>
