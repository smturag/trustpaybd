            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive" id="tableContentWrap">
                        ...
                        @include('merchant.modem.modem_table_content')
                    </div>
    ...
    <script type="text/javascript">
        ...
        function delete_record(id, title) {
            ...
            swal({
                ...
                .then((isConfirm) => {
                    if (isConfirm) {
                        $.ajax({
                            url: "{{ url('merchant/modem_delete/') }}/" + id,
                            headers: {
        ...
        $(document).ready(function() {
            ...
            $(document).on('click', '.openPopup', function(event) {
                var id = $(this).attr('id');
                var dataURL = "{{ url('/merchant/modem_set_merchant') }}/" + id;
        ...
        function changeOperatingStatus(modemId, status) {
            const url = `/merchant/modem_operating_status/${modemId}/${status}`;
