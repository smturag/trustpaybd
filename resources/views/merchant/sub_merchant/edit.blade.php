            ...
            <div class="card  col-md-6 mx-auto">
                <div class="card-body d-flex justify-content-center align-items-center" style="height: 100%;">
                    <div class="item-content w-100">
                        <form class="row g-3" action="{{ route('sub_merchant.update',['id'=>$data->id]) }}" method="POST">
                            @csrf
                            <div class="col-md-12">
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="email" value="{{ $data->email }}" onkeyup="notspace(this);" name="email"
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="tel" value="{{ $data->mobile }}" onkeyup="notspace(this);" name="mobile"
                            ...
                            <div class="col-md-12">
                                ...
                                <input type="password" onkeyup="notspace(this);" name="password"
