            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="table-responsive" id="tableContentWrap">
                        @include('merchant.bm.balance-manager-content')
                    </div>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            ...
            $(document).on('click', '.openPopup', function (e) {
                ...
                var dataURL = "{{ url('/merchant/approved-balance-manager') }}/"+id;
            ...
            $(document).on('click', '.rejectBalance', function (event) {
                ...
                if (confirm('Are you sure to delete this record?')) {
                    $.ajax({
                        type: 'POST',
                        url: "{{ url('/merchant/reject-balance-manager') }}/" + id,
                        data: {_token: _token},
        ...
        function redirectToSimNumber(val) {
            window.location.href = "/merchant/balance-manager/{{ Request::segment(3) }}/" + val;
        }
