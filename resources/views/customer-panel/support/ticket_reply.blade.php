            ...
            <div class="col-xl-6">
                <div class="card">
                    <div class="card-body p-4">
                        ...
                        @endif
                        <a href="{{ route('customer.ticketClose', $ticket_object->ticket) }}"
                        ...
                        <form class="row g-3" method="POST"
                            action="{{ route('customer.ticketReplyStore', $ticket_object->ticket) }}" accept-charset="UTF-8">
                            {{ csrf_field() }}
                                    ...
                                    @foreach ($ticket_data as $data)
                                        <div class="panel-body">
                                            <fieldset class="col-md-12">
                                                @if ($data->type == 1)
                                                    <legend><span style="color: #0e76a8">{{ auth('customer')->user()->customer_name }}</span>
                                                        ,
