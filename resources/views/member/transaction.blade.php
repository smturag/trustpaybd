                ...
                <div class="card">
                    <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="single-select-field" name="simNumber" id="simNumber" onchange="return redirectToSimNumber(this.options[this.selectedIndex].value);">
                                            ...
                                            @foreach($sim as $simNumber)
                                                @if($simNumber->sim_number != "")
                                                    <option value="{{ $simNumber->sim_number }}" @selected($simNumber->sim_number == Request::segment(3))>{{ $simNumber->sim_number }}</option>
                                                @endif
                                            @endforeach
                                        </select>
                                    </div>
                        ...
                        <div class="table-responsive" id="tableContentWrap">
                            @include('member.transaction-content')
                        </div>
    ...
    <script type="text/javascript">
        $(document).ready(function(){
			 $(document).on('click', '.openPopup', function (e) {
                ...
                var dataURL = "{{ url('/approved-transaction') }}/"+id;
