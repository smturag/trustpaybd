    ...
    <div class="col-xl-6">
        <div class="card">
            <div class="card-body p-4">
                ...
                <form class="row g-3"  action="{{ route('member.profile_update', ['id' => $user->id]) }}"  method="POST">
                    @csrf
                    <div class="col-md-12">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="mobile" placeholder="please add with country code 8801xxxxxxxxx" class="form-control @error('mobile') is-invalid @enderror" id="mobile" value="{{ $user->mobile }}">
                        @error('mobile')
                            <div class="alert alert-danger">{{ $message }}</div>
                        @enderror
                    </div>
