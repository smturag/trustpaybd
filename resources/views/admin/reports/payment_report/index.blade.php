...
@section('content')
    ...
    <div class="row">
        <div class="col-xl-12 mx-auto">
            ...
            <div class="card">
                <div class="card-body">
                    <form action="#" data-route="{{ route('report.payment_report') }}"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2">
                                <div class="form-group">
                                    ...
                                    <select name="status" class="form-control" id="profileType">
                    ...
                    <div class="table-responsive" id="tableContentWrap">
                        @include('admin.reports.payment_report.table')
                    </div>
                </div>
            </div>
        </div>
