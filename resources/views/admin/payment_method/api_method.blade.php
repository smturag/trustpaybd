    ...
    <div class="row">
        <div class="col-xl-12 mx-auto">
            <div class="header d-flex align-items-center mb-3">
                ...
                <!--<a class="ms-auto btn btn-sm btn-primary" href="{{ route('payment.add_api_method') }}">-->
                            ...
                            @foreach ($data as $key => $item)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{ route('payment.api_method_edit',['id'=>$item->id]) }}" class="btn btn-outline-primary mt-2">Edit</a>
                                        {{-- <div class="btn-group">
