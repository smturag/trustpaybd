        ...
        <div class="col-xl-6 mx-auto">
            <div class="card">
                <div class="card-body p-4">
                    <h5 class="mb-4">Add provider for Send SMS and WhatsApp</h5>
                    <hr>
                    <form class="row g-3" action="{{ route('bulk_sms.store') }}" method="POST">
                        @csrf
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="common_link" class="form-control" id="bsValidation3" placeholder="Name" required>
                        ...
                        <div class="col-md-12">
                            ...
                            <input type="text" name="access_token" class="form-control" id="bsValidation3" placeholder="Access token" required>
                            <div class="invalid-feedback">
