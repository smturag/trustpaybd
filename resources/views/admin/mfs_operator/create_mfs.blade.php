        ...
        <div class="col-xl-6 mx-auto">
            <div class="card">
                <div class="card-body p-4">
                    <h5 class="mb-4">Create MFS</h5>
                    <hr>

                    <form action="{{ route('mfs.insert_mfs') }}" method="POST" enctype="multipart/form-data" class="row g-3">
                        @csrf

                        {{-- MFS Name --}}
                        <div class="col-md-12">
                            <label for="mfs_name" class="form-label">MFS Name</label>
                            <input type="text" name="mfs_name" value="{{ old('mfs_name') }}" class="form-control"
                        ...
                        <div class="col-md-12">
                            ...
                            <select name="mfs_type" id="mfs_type" class="form-control">
                                ...
                                <option value="P2A" {{ old('mfs_type') == 'P2A' ? 'selected' : '' }}>P2A</option>
                                <option value="P2C" {{ old('mfs_type') == 'P2A' ? 'selected' : '' }}>P2C</option>
                                <option value="P2P" {{ old('mfs_type') == 'P2P' ? 'selected' : '' }}>P2P</option>
                            </select>
                            @error('mfs_type')
                                <span class="error text-danger">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" name="deposit_fee" value="{{ old('deposit_fee', 0) }}"
                                class="form-control" placeholder="Deposit Fee">
                            @error('deposit_fee')
                                <span class="error text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" name="deposit_commission"
                                value="{{ old('deposit_commission', 0) }}" class="form-control"
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" name="withdraw_fee" value="{{ old('withdraw_fee', 0) }}"
                                class="form-control" placeholder="Withdraw Fee">
                            @error('withdraw_fee')
                                <span class="error text-danger">{{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="number" step="0.01" name="withdraw_commission"
                                value="{{ old('withdraw_commission', 0) }}" class="form-control"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-check form-switch">
                                <input class="form-check-input" id="switch-button" type="checkbox" name="mfs_status"
                                    checked>
                                <label class="form-check-label" id="status-label" for="switch-button">on</label>
                            </div>
                        </div>
