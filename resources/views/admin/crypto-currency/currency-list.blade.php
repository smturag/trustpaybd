    ...
    <div class="row">
        <div class="col-xl-12 mx-auto">
            <div class="header d-flex align-items-center mb-3">
                <h6 class="mb-0 text-uppercase ps-3">Crypto Currency List</h6>
                <a class="ms-auto btn btn-sm btn-primary" href="{{ route('crypto.create_currency_form') }}">
                    <i class="bx bx-plus mr-1"></i> Add Currency
                </a>
            </div>
            <hr/>
                    ...
                    <table id="data_table" class="display">
                        ...
                        @foreach ($data as $key => $data)
                            <tr>
                                ...
                                <td>
                                    <form action="{{ route('crypto.destroy') }}" method="POST" id="deleteForm">
                                        @csrf
    ...
    <script>
        $(document).ready(function () {
            ...
            $('#data_table').on('click', '.form-check-input', function () {
                ...
                var url = "{{ route('crypto.edit_status') }}";
