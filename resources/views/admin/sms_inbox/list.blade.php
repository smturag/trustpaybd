            ...
            <div class="card">
                <div class="card-body">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <select class="form-control" name="sender" id="sender">
                                        ...
                                        <?php $mfssend = DB::table('sms_inboxes')->select('sender')->get()->unique('sender'); ?>

                                        @foreach($mfssend as $rpt)
                                            <option value="{{ $rpt->sender }}">{{ translate($rpt->sender) }}</option>
                                        @endforeach
                                    </select>
                                </div>
                            </div>
                    ...
                    <div class="table-responsive" id="tableContentWrap">
                        @include('admin.sms_inbox.inbox_table_content')
                    </div>
