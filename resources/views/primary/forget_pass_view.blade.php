    ...
    <head>
        ...
        <style type="text/css">
            ...
            .card.custom-card {
                width: 80%;
                margin: 0 auto;
                /* This will center the card body horizontally */
            }
                                ...
                                <div class="card-body ">
                                    ...
                                    <div class="p-4">
                                        ...
                                        <div class="text-center mb-4">
                                            ...
                                            <p class="mb-0">Put email for reset your password</p>
                                        ...
                                        <div class="form-body">
                                            ...
                                            <form class="row g-3" action="{{ route('customer.forget_password_customer') }}"
